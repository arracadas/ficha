---
title: "Reporte Estadístico - Temporada Primavera 2025"
author: "piztachz"
toc: true
...
Dominó, el juego mágico de fichas que nos transporta a un mundo de estrategia y números! Entre amigos el dominó es ley, con cervezas, risas y algún que otro **¡zapatazo!**. ![](assets/fichas_mesa.png){style="float:left; margin-right: 20px; margin-top: 10px;" fig-alt="Juego de dominó" height="140"}\
...
![](assets/corona_extra){style="float:left; margin-right: 20px; margin-bottom: 10px;" fig-alt="La cerveza es Corona" height="100"} **¡Vaya temporada de *locura*, compadres!** Todo se definió en un **juego final *a cuchillo*** de **12 puntos** —*12 navajazos* en el corazón de **Jerry y Piztache**, que sepultaron cualquier esperanza de vida. **El Oso**, habiendo arrancado la temporada *más perdido que turista en las calles del Centro*, aguantó vara y como los osos de Alaska, persistió en la búsqueda del salmón 🐻🐟 , escalando posiciones como si nada, hasta llegar a la cima. Mientras, **Piztache** hizo lo contrario: arrancó *como cohete en Año Nuevo*… pero se quedó sin gasolina y terminó *en el sótanito* de la tabla, *raspando lona*.
